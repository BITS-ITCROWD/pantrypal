...
<head>
  ...
  <?php
      ...
      // added by Jane: determine if recipe is a favourite	- this is all my own code
      /* 09/08/16 Jane Debug: Could not add a favourite if someone already had it.
       Added user id to favourites test select statement row 82 and removed unique from 
      recipenumber in favourites table in db */
         ...
         <div class = "row">
            ...
            <div class = "col-md-3" style = "margin: 2em 0 0 0">
               ...
               <!--Jane including add to favourites and remove favourite
                  button name confirms success - this is all my own code-->
               ...
               ?>   	
               	...
               	<div>
                     ...
                     <button id="lukemyBtn" class = "btn btn-primary">Add to Meal Planner</button></br></br>
                                 ...
                                 <!--Added by Jane: Add to favourites button - this is my own code-->
                     
                     <form action = "" method="post">
                     <button type="submit" button id="Add_Favourites" class = "btn btn-primary" 
                     name="favsubmit"><?php echo $fav_btn_name?></button>
                     </form>

...
redips.init = function () {
	...
	$('#dialog').dialog({
		...
		width: 400,
		height: 170,
		// define Shift, Switch and Overwrite buttons. Note I have removed Shift option - didn't like it. 
		// 	I have added a Cancel option - Paul 03/07/2016
		buttons: {
			/*  
			'Shift': function () {
			...
			// added by Paul Gauci 03/07/2016
			'Cancel': function(){
				// close dialog
				rd.enableDrag(true, rd.td.target);
